...
class IntegratedThreeJSModal {
    ...
    loadGLTFMannequin(type) {
        ...
        const modelUrls = {
            ...
            'female': [
                'https://threejs.org/examples/models/gltf/Xbot.glb', // Same model, different material
                '/models/XBot.glb'
            ],
            'anime-male': [
                'https://threejs.org/examples/models/gltf/Soldier.glb', // Will be styled as anime
                './models/Soldier.glb'
            ],
            'anime-female': [
                'https://threejs.org/examples/models/gltf/Xbot.glb', // Same model, different material
