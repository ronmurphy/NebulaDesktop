...
class NebulaImageEditor {
    ...
    async processArtJob(job, modal) {
        try {
            ...
            // Simulate generation delay and create a dummy image matching requested size
            ...
            ctx.fillText('Generated by OLLIE', 12, 28);
    ...
    addGeneratedToGallery(job) {
        ...
        this.generatedImages.unshift({ id: job.id, prompt: job.prompt, dataURL: job.result.dataURL, meta: job });
        this.renderGallery();
    }
