...
class NebulaSettings {
    ...
    renderEffectsTab() {
        return `
            <div class="tab-header" style="margin-bottom: 30px;">
                ...
                <p style="color: var(--nebula-text-secondary); margin: 0; font-size: 16px;">Animations, transitions, and visual effects</p>
            </div>
            ...
            <div class="settings-section" style="background: var(--nebula-surface); border: 1px solid var(--nebula-border); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 20px;">
                    <div>
                        ...
                        <div style="margin-top: 8px; font-size: 12px; color: var(--nebula-text-secondary);">Speed of window open/close animations</div>
                    </div>
                    
                    <div>
                        <label style="display: block; margin-bottom: 8px; color: var(--nebula-text-primary); font-weight: 500;">Enable Animations</label>
                        <div style="display: flex; align-items: center; gap: 12px; margin-top: 12px;">
                            <label style="display: flex; align-items: center; gap: 8px; cursor: pointer;">
                                <input type="checkbox" id="enableAnimations" checked style="
                                    width: 18px;
                                    height: 18px;
                                    accent-color: var(--nebula-primary);
                                    cursor: pointer;
                                ">
                                <span style="color: var(--nebula-text-primary);">Window animations</span>
                            </label>
                        </div>
                        <div style="margin-top: 8px; font-size: 12px; color: var(--nebula-text-secondary);">Disable for better performance</div>
                    </div>
                </div>
                
                <!-- Animation Preview -->
                <div style="background: var(--nebula-bg-secondary); border-radius: 8px; padding: 20px; text-align: center;">
                    <button id="testAnimation" style="
                        background: var(--nebula-primary);
                        color: white;
                        border: none;
                        padding: 12px 24px;
                        ...
                        font-weight: 500;
                        transition: all 0.2s ease;
                    ">Test Window Animation</button>
                    <div style="margin-top: 8px; font-size: 12px; color: var(--nebula-text-secondary);">Preview animation effects</div>
                </div>
            </div>

            <!-- Transition Effects -->
            <div class="settings-section" style="background: var(--nebula-surface); border: 1px solid var(--nebula-border); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
                <h3 style="color: var(--nebula-text-primary); margin: 0 0 16px 0; font-size: 18px; font-weight: 600;">Transition Effects</h3>
                
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
                    <div style="background: var(--nebula-bg-secondary); border-radius: 8px; padding: 16px; text-align: center; cursor: pointer; border: 2px solid var(--nebula-border); transition: all 0.2s ease;" class="effect-card" data-effect="fade">
                        <div style="font-size: 24px; margin-bottom: 8px;">🌅</div>
                        <div style="font-weight: 600; margin-bottom: 4px; color: var(--nebula-text-primary);">Fade</div>
                        <div style="font-size: 12px; color: var(--nebula-text-secondary);">Smooth opacity transition</div>
                    </div>
                    
                    <div style="background: var(--nebula-bg-secondary); border-radius: 8px; padding: 16px; text-align: center; cursor: pointer; border: 2px solid var(--nebula-primary); transition: all 0.2s ease;" class="effect-card selected" data-effect="slide">
                        <div style="font-size: 24px; margin-bottom: 8px;">↗️</div>
                        <div style="font-weight: 600; margin-bottom: 4px; color: var(--nebula-text-primary);">Slide</div>
                        <div style="font-size: 12px; color: var(--nebula-text-secondary);">Slide from bottom</div>
                    </div>
                    
                    <div style="background: var(--nebula-bg-secondary); border-radius: 8px; padding: 16px; text-align: center; cursor: pointer; border: 2px solid var(--nebula-border); transition: all 0.2s ease;" class="effect-card" data-effect="scale">
                        <div style="font-size: 24px; margin-bottom: 8px;">🔍</div>
                        <div style="font-weight: 600; margin-bottom: 4px; color: var(--nebula-text-primary);">Scale</div>
                        <div style="font-size: 12px; color: var(--nebula-text-secondary);">Zoom in/out effect</div>
                    </div>
                    
                    <div style="background: var(--nebula-bg-secondary); border-radius: 8px; padding: 16px; text-align: center; cursor: pointer; border: 2px solid var(--nebula-border); transition: all 0.2s ease;" class="effect-card" data-effect="bounce">
                        <div style="font-size: 24px; margin-bottom: 8px;">🏀</div>
                        <div style="font-weight: 600; margin-bottom: 4px; color: var(--nebula-text-primary);">Bounce</div>
                        <div style="font-size: 12px; color: var(--nebula-text-secondary);">Playful bounce effect</div>
                    </div>
                </div>
            </div>
            ...
            <div class="settings-section" style="background: var(--nebula-surface); border: 1px solid var(--nebula-border); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                    <div>
                        <label style="display: flex; align-items: center; gap: 12px; cursor: pointer; color: var(--nebula-text-primary); font-weight: 500;">
                            <input type="checkbox" id="enableParticles" style="
                                width: 18px;
                                height: 18px;
                                accent-color: var(--nebula-primary);
                                cursor: pointer;
                        ...
                        <div style="margin-top: 8px; font-size: 12px; color: var(--nebula-text-secondary);">Subtle animated particles on desktop</div>
                    </div>
                    
                    <div>
                        <label style="display: flex; align-items: center; gap: 12px; cursor: pointer; color: var(--nebula-text-primary); font-weight: 500;">
                            <input type="checkbox" id="enableMotionBlur" style="
                                width: 18px;
                                height: 18px;
                                accent-color: var(--nebula-primary);
                                cursor: pointer;
                        ...
                        <div style="margin-top: 8px; font-size: 12px; color: var(--nebula-text-secondary);">Blur effects during window movement</div>
                    </div>
                    
                    <div>
                        <label style="display: flex; align-items: center; gap: 12px; cursor: pointer; color: var(--nebula-text-primary); font-weight: 500;">
                            <input type="checkbox" id="enableGlow" style="
                                width: 18px;
                                height: 18px;
                                accent-color: var(--nebula-primary);
                                cursor: pointer;
                        ...
                        <div style="margin-top: 8px; font-size: 12px; color: var(--nebula-text-secondary);">Soft glow around active windows</div>
                    </div>
                    
                    <div>
                        <label style="display: flex; align-items: center; gap: 12px; cursor: pointer; color: var(--nebula-text-primary); font-weight: 500;">
                            <input type="checkbox" id="enableRainbow" style="
                                width: 18px;
                                height: 18px;
                                accent-color: var(--nebula-primary);
                                cursor: pointer;
                        ...
                        <div style="margin-top: 8px; font-size: 12px; color: var(--nebula-text-secondary);">Cycling rainbow colors (fun mode!)</div>
                    </div>
                </div>
            </div>
            ...
            <div class="settings-section" style="background: var(--nebula-surface); border: 1px solid var(--nebula-border); border-radius: 12px; padding: 24px;">
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
                    <div>
                        <div style="color: var(--nebula-text-primary); font-weight: 500; margin-bottom: 4px;">Reduce Motion</div>
                        <div style="color: var(--nebula-text-secondary); font-size: 14px;">Disable animations for better performance</div>
                    </div>
                    <label style="cursor: pointer;">
                        <input type="checkbox" id="reduceMotion" style="
                            width: 18px;
                            height: 18px;
                            accent-color: var(--nebula-primary);
                            cursor: pointer;
    ...
    setupEffectsListeners(container) {
        ...
        // Effect cards
        const effectCards = container.querySelectorAll('.effect-card');
        effectCards.forEach(card => {
            card.addEventListener('click', () => {
                ...
                card.style.borderColor = 'var(--nebula-primary)';
        ...
        applyBtn?.addEventListener('click', () => {
            this.applyEffects(container);
        });
        
        resetBtn?.addEventListener('click', () => {
            this.resetEffects(container);
        });
    }
    ...
    createTestAnimation() {
        ...
        testWindow.textContent = '✨ Animation Test';
    ...
    applyEffects(container) {
        const settings = this.gatherEffectSettings(container);
        
        // Apply animation speed
        document.documentElement.style.setProperty('--nebula-transition-speed', `${settings.animationSpeed}s`);
        
        // Apply motion preferences
        if (settings.reduceMotion) {
            document.documentElement.style.setProperty('--nebula-transition', 'none');
        } else {
            document.documentElement.style.setProperty('--nebula-transition', 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)');
        }
        
        // Add/remove effect classes
        document.body.classList.toggle('effects-particles', settings.enableParticles);
        document.body.classList.toggle('effects-motion-blur', settings.enableMotionBlur);
        document.body.classList.toggle('effects-glow', settings.enableGlow);
        document.body.classList.toggle('effects-rainbow', settings.enableRainbow);
        
        console.log('Effects applied:', settings);
    }
    
    /**
     * Gather current effect settings
     */
    gatherEffectSettings(container) {
        return {
            animationSpeed: parseFloat(container.querySelector('#animationSpeed')?.value || 1),
            enableAnimations: container.querySelector('#enableAnimations')?.checked || false,
            enableParticles: container.querySelector('#enableParticles')?.checked || false,
            enableMotionBlur: container.querySelector('#enableMotionBlur')?.checked || false,
            enableGlow: container.querySelector('#enableGlow')?.checked || false,
            enableRainbow: container.querySelector('#enableRainbow')?.checked || false,
            reduceMotion: container.querySelector('#reduceMotion')?.checked || false
        };
    }
    ...
    resetEffects(container) {
        const defaults = [
            { id: 'animationSpeed', value: 1 },
            { id: 'enableAnimations', checked: true },
            { id: 'enableParticles', checked: false },
            { id: 'enableMotionBlur', checked: false },
            { id: 'enableGlow', checked: false },
            { id: 'enableRainbow', checked: false },
            { id: 'reduceMotion', checked: false }
        ];
        
        defaults.forEach(({ id, value, checked }) => {
            ...
            if (element) {
                if (typeof checked === 'boolean') {
                    ...
                    if (id === 'animationSpeed') {
                        container.querySelector('#animationSpeedValue').textContent = value.toFixed(1);
                    }
                }
            }
        });
    ...
    renderSystemTab() {
        return `
            <div class="tab-header" style="margin-bottom: 30px;">
                ...
                <p style="color: var(--nebula-text-secondary); margin: 0; font-size: 16px;">System information, storage, and advanced settings</p>
            </div>
            ...
            <div class="settings-section" style="background: var(--nebula-surface); border: 1px solid var(--nebula-border); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
                ...
                <div class="system-info-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
            ...
            <div class="settings-section" style="background: var(--nebula-surface); border: 1px solid var(--nebula-border); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
                ...
                <div class="shortcuts-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 12px;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px; background: var(--nebula-bg-secondary); border-radius: 6px;">
                        <span style="color: var(--nebula-text-primary); font-weight: 500;">New Terminal</span>
            ...
            <!-- About Section -->
            <div class="settings-section" style="background: var(--nebula-surface); border: 1px solid var(--nebula-border); border-radius: 12px; padding: 24px;">
                <h3 style="color: var(--nebula-text-primary); margin: 0 0 16px 0; font-size: 18px; font-weight: 600;">About</h3>
                
                <div style="text-align: center; padding: 20px;">
                    <div style="font-size: 48px; margin-bottom: 16px;">✨</div>
                    <h4 style="color: var(--nebula-text-primary); margin: 0 0 8px 0; font-size: 24px; font-weight: 700;">NebulaDesktop</h4>
                    <p style="color: var(--nebula-text-secondary); margin: 0 0 16px 0; font-size: 16px;">A modern, web-based desktop environment</p>
                    <p style="color: var(--nebula-text-secondary); font-size: 14px; line-height: 1.5; max-width: 500px; margin: 0 auto;">
                        Built with Electron, featuring a ChromeOS-inspired interface with integrated window management, 
                        AI assistant, powerful terminal, and extensive customization options.
                    </p>
                    
                    <div style="margin-top: 24px; display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
                        <button id="aboutCredits" style="
                            background: var(--nebula-surface-hover);
                            color: var(--nebula-text-primary);
                            border: 1px solid var(--nebula-border);
                            padding: 8px 16px;
    ...
    setupSystemListeners(container) {
        ...
        // About buttons
        const creditsBtn = container.querySelector('#aboutCredits');
        const licenseBtn = container.querySelector('#aboutLicense');
        const updatesBtn = container.querySelector('#checkUpdates');
        
        creditsBtn?.addEventListener('click', () => this.showCredits());
        licenseBtn?.addEventListener('click', () => this.showLicense());
        updatesBtn?.addEventListener('click', () => this.checkForUpdates());
    ...
    /**
     * Export all settings (comprehensive)
     */
    exportAllSettings() {
        try {
            const allSettings = {
                ...
                effects: this.gatherEffectSettings(document.querySelector('.settings-content')),
                preferences: {}
            };
            ...
            console.log('Complete settings exported successfully');
    ...
    /**
     * Import all settings (comprehensive)
     */
    async importAllSettings(file, container) {
        if (!file) return;
        ...
        try {
            ...
            this.saveSettings();
            alert(`Settings imported successfully from ${new Date(settings.exportDate).toLocaleDateString()}!`);
            
            // Refresh current tab
            this.showTab(this.activeTab, container.closest('.settings-container'));
     ...
     */
    showCredits() {
        alert(`NebulaDesktop Credits:

🚀 Built with Electron & Web Technologies
🎨 Material Design Icons by Google
✨ Inspired by ChromeOS & Modern Web UIs
💻 Terminal powered by XTerm.js
🤖 AI Assistant integration
⚡ Window management & customization

Created with passion for modern desktop computing!`);
    }
...
For full license text, see the LICENSE file in the project repository.`);
    }
...
✅ You are running NebulaDesktop v3.0
